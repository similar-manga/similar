...
*/
func (a *AuthorApiService) GetAuthorId(ctx context.Context, id string) (AuthorResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param optional nil or *AuthorApiPostAuthorOpts - Optional Parameters:
     * @param "Body" (optional.Interface of AuthorCreate) -  This body is limited to 2kb max per call.
@return AuthorResponse
*/
 ...
 * @param optional nil or *AuthorApiPutAuthorIdOpts - Optional Parameters:
     * @param "Body" (optional.Interface of AuthorEdit) -  This body is limited to 2kb max per call.
@return AuthorResponse
*/
