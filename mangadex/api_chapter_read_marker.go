...
*/
func (a *ChapterReadMarkerApiService) ChapterIdRead(ctx context.Context, id string) (InlineResponse2004, *http.Response, error) {
	var (
...
@return InlineResponse2004
*/
func (a *ChapterReadMarkerApiService) ChapterIdUnread(ctx context.Context, id string) (InlineResponse2004, *http.Response, error) {
	var (
...
*/
func (a *ChapterReadMarkerApiService) GetMangaChapterReadmarkers(ctx context.Context, id string) (InlineResponse2001, *http.Response, error) {
	var (
...
func (a *ChapterReadMarkerApiService) GetMangaChapterReadmarkers2(ctx context.Context, ids []string, localVarOptionals *ChapterReadMarkerApiGetMangaChapterReadmarkers2Opts) (InlineResponse2003, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *ChapterReadMarkerApiService) PostMangaChapterReadmarkers(ctx context.Context, id string, localVarOptionals *ChapterReadMarkerApiPostMangaChapterReadmarkersOpts) (InlineResponse2002, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
