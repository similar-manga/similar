...
type ChapterReadMarkerApiService service
/*
ChapterReadMarkerApiService Mark Chapter read
Mark chapter as read for the current user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return InlineResponse2005
*/
func (a *ChapterReadMarkerApiService) ChapterIdRead(ctx context.Context, id string) (InlineResponse2005, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/chapter/{id}/read"
...
/*
ChapterReadMarkerApiService Mark Chapter unread
Mark chapter as unread for the current user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return InlineResponse2005
*/
func (a *ChapterReadMarkerApiService) ChapterIdUnread(ctx context.Context, id string) (InlineResponse2005, *http.Response, error) {
	var (
...
/*
ChapterReadMarkerApiService Manga read markers
A list of chapter ids that are marked as read for the specified manga
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return InlineResponse2002
*/
func (a *ChapterReadMarkerApiService) GetMangaChapterReadmarkers(ctx context.Context, id string) (InlineResponse2002, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ids Manga ids
 * @param optional nil or *ChapterReadMarkerApiGetMangaChapterReadmarkers2Opts - Optional Parameters:
     * @param "Grouped" (optional.Bool) -  Group results by manga ids
@return InlineResponse2004
*/

type ChapterReadMarkerApiGetMangaChapterReadmarkers2Opts struct {
    Grouped optional.Bool
}

func (a *ChapterReadMarkerApiService) GetMangaChapterReadmarkers2(ctx context.Context, ids []string, localVarOptionals *ChapterReadMarkerApiGetMangaChapterReadmarkers2Opts) (InlineResponse2004, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
ChapterReadMarkerApiService Manga read markers batch
Send a lot of chapter ids for one manga to mark as read and/or unread
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *ChapterReadMarkerApiPostMangaChapterReadmarkersOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ChapterReadMarkerBatch) -  The size of the body is limited to 10KB.
@return InlineResponse2003
*/

type ChapterReadMarkerApiPostMangaChapterReadmarkersOpts struct {
    Body optional.Interface
}

func (a *ChapterReadMarkerApiService) PostMangaChapterReadmarkers(ctx context.Context, id string, localVarOptionals *ChapterReadMarkerApiPostMangaChapterReadmarkersOpts) (InlineResponse2003, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
