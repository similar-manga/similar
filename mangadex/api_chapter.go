...
*/
func (a *ChapterApiService) ChapterIdRead(ctx context.Context, id string) (InlineResponse2003, *http.Response, error) {
	var (
...
@return InlineResponse2003
*/
func (a *ChapterApiService) ChapterIdUnread(ctx context.Context, id string) (InlineResponse2003, *http.Response, error) {
	var (
...
/*
ChapterApiService Get logged User followed Manga feed (Chapter list)
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ChapterApiGetUserFollowsMangaFeedOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) - 
     * @param "Offset" (optional.Int32) - 
     * @param "TranslatedLanguage" (optional.Interface of []string) - 
     * @param "CreatedAtSince" (optional.String) - 
...
type ChapterApiGetUserFollowsMangaFeedOpts struct {
    Limit optional.Int32
    Offset optional.Int32
    TranslatedLanguage optional.Interface
    CreatedAtSince optional.String
...
func (a *ChapterApiService) GetUserFollowsMangaFeed(ctx context.Context, localVarOptionals *ChapterApiGetUserFollowsMangaFeedOpts) (ChapterList, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
