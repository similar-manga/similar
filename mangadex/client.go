...
// APIClient manages communication with the MangaDex API API v5.5.7
...
type APIClient struct {
	...
	ChapterReadMarkerApi *ChapterReadMarkerApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ChapterReadMarkerApi = (*ChapterReadMarkerApiService)(&c.common)
