...
func (a *AtHomeApiService) GetAtHomeServerChapterId(ctx context.Context, chapterId string, localVarOptionals *AtHomeApiGetAtHomeServerChapterIdOpts) (InlineResponse2005, *http.Response, error) {
	var (
