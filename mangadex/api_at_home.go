...
func (a *AtHomeApiService) GetAtHomeServerChapterId(ctx context.Context, chapterId string, localVarOptionals *AtHomeApiGetAtHomeServerChapterIdOpts) (InlineResponse2004, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/at-home/server/{chapterId}"
