 ...
 * @param optional nil or *AuthorApiPostAuthorOpts - Optional Parameters:
     * @param "Body" (optional.Interface of AuthorCreate) -  The size of the body is limited to 2KB.
@return AuthorResponse
*/
 ...
 * @param optional nil or *AuthorApiPutAuthorIdOpts - Optional Parameters:
     * @param "Body" (optional.Interface of AuthorEdit) -  The size of the body is limited to 2KB.
@return AuthorResponse
*/
