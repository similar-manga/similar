...
*/
func (a *MangaApiService) GetMangaIdStatus(ctx context.Context, id string) (InlineResponse2008, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *MangaApiService) GetMangaStatus(ctx context.Context, localVarOptionals *MangaApiGetMangaStatusOpts) (InlineResponse2007, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Manga ID
 * @param optional nil or *MangaApiMangaIdAggregateGetOpts - Optional Parameters:
     * @param "TranslatedLanguage" (optional.Interface of []string) - 
     * @param "Groups" (optional.Interface of []string) - 
@return InlineResponse200
*/

type MangaApiMangaIdAggregateGetOpts struct {
    TranslatedLanguage optional.Interface
    Groups optional.Interface
}

func (a *MangaApiService) MangaIdAggregateGet(ctx context.Context, id string, localVarOptionals *MangaApiMangaIdAggregateGetOpts) (InlineResponse200, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
