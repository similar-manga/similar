 ...
 * @param optional nil or *LegacyApiPostLegacyMappingOpts - Optional Parameters:
     * @param "Body" (optional.Interface of MappingIdBody) -  This body is limited to 10kb max per call.
...
func (a *LegacyApiService) PostLegacyMapping(ctx context.Context, localVarOptionals *LegacyApiPostLegacyMappingOpts) ([]MappingIdResponse, *http.Response, error) {
	var (
