...
func (a *AuthApiService) PostAuthLogin(ctx context.Context, contentType string, localVarOptionals *AuthApiPostAuthLoginOpts) (LoginResponse, *http.Response, error) {
	var (
...
func (a *AuthApiService) PostAuthRefresh(ctx context.Context, contentType string, localVarOptionals *AuthApiPostAuthRefreshOpts) (RefreshResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
