...
func (a *CoverApiService) EditCover(ctx context.Context, coverId string, localVarOptionals *CoverApiEditCoverOpts) (CoverResponse, *http.Response, error) {
	var (
...
func (a *CoverApiService) UploadCover(ctx context.Context, mangaId string, localVarOptionals *CoverApiUploadCoverOpts) (CoverResponse, *http.Response, error) {
	var (
