...
@return Response
*/
func (a *CoverApiService) DeleteCover(ctx context.Context, coverId string) (Response, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/cover/{coverId}"
	localVarPath = strings.Replace(localVarPath, "{"+"coverId"+"}", fmt.Sprintf("%v", coverId), -1)
...
func (a *CoverApiService) EditCover(ctx context.Context, contentType string, coverId string, localVarOptionals *CoverApiEditCoverOpts) (CoverResponse, *http.Response, error) {
	var (
...
func (a *CoverApiService) GetCoverId(ctx context.Context, coverId string, localVarOptionals *CoverApiGetCoverIdOpts) (CoverResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *CoverApiService) UploadCover(ctx context.Context, contentType string, mangaId string, localVarOptionals *CoverApiUploadCoverOpts) (CoverResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/cover/{mangaId}"
