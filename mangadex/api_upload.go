...
func (a *UploadApiService) PutUploadSessionFile(ctx context.Context, contentType string, uploadSessionId string, localVarOptionals *UploadApiPutUploadSessionFileOpts) (InlineResponse2009, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
