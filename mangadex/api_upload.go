...
/*
UploadApiService Upload Cover
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param mangaId
 * @param optional nil or *UploadApiUploadCoverOpts - Optional Parameters:
     * @param "File" (optional.*os.File) - 
@return CoverResponse
*/

type UploadApiUploadCoverOpts struct {
    File optional.Interface
}

func (a *UploadApiService) UploadCover(ctx context.Context, mangaId string, localVarOptionals *UploadApiUploadCoverOpts) (CoverResponse, *http.Response, error) {
	var (
